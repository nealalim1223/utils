...
const emailApproverSection = (type, currentUrl, data, currentApprover) => {
  return (`
    ...
    return `
          ...
          ${approval.attachment && (`<p><b>Attachment:</b> <a href="${approval.attachment}" target="_blank"><img src="${approval.attachment}" alt="Attachment" style="width:100px;height:100px;" /></a></p>`)}
